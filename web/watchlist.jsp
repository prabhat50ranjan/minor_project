<%-- 
    Document   : watchlist.jsp
    Created on : Mar 20, 2017, 10:51:14 PM
...
<table width="100%" border="0">
  ...
  <tr valign="top">
    <td bgcolor="#00FFCC" width="50">
     <center> <b><font color=black size=6 face=WildWest>CONDITION OF YOUR LIST</font></b></br>
      <font color=black size=5 face=WildWest>TOP GAINERS</font><br />
      <font color=black size=5 face=WildWest>TOP LOSERS</font><br />
      <font color=black size=5 face=WildWest>FALLING STOCK PRICES</font><br>
      <font color=black size=5 face=WildWest>CHARTS</font><br>
      <font color=black size=5 face=WildWest>NEWS FOR YOUR LIST</font><br>
      <br/></center>
           
      </td>
    <td bgcolor="#FFFFCC" width="100" height="200">
    <center><b><font color=black size=6 face=WildWest>Main Menu</font></b><br />
     <a href="djia.jsp"> <font color=black size=5 face=WildWest>DJIA</font></a><br />
      <font color=black size=5 face=WildWest>INFOSYS</font><br />
      <font color=black size=5 face=WildWest>TCS</font><br/></center
    </td>
  </tr>
  <tr>
